...
contract HashingTest {
	...
	function IterativeHash(
		...
		bytes32 checkpoint = keccak256(abi.encode(_hyperionId, methodName, _valsetNonce));
	...
	function ConcatHash(
		...
		bytes32 idHash = keccak256(abi.encode(_hyperionId, methodName, _valsetNonce));
	...
	function ConcatHash2(
		...
		bytes32 checkpoint = keccak256(
			abi.encode(_hyperionId, methodName, _valsetNonce, _validators, _powers)
		);
